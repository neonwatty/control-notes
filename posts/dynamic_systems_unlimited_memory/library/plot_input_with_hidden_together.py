...
class Plotter:
    ...
    def process(self,x,h,**kwargs):
        ...
        ax.scatter(np.arange(1,counter+1),h[:counter],c = 'darkorange',edgecolor = 'w',s = 120,linewidth = 1,zorder = 2);
        ax.plot(np.arange(1,counter+1),h[:counter],alpha = 0.5,c = 'darkorange',zorder = 2);
