...
class Setup:
    def __init__(self,train_cost_histories,train_count_histories,valid_cost_histories,valid_count_histories,start):
        ...
        if len(train_count_histories) == 0:
            ...
            self.plot_acc_histories(train_cost_histories,train_count_histories,valid_cost_histories,valid_count_histories,start)
    ...
    def plot_acc_histories(self,train_cost_histories,train_count_histories,valid_cost_histories,valid_count_histories,start):        
        # initialize figure
        fig = plt.figure(figsize = (10,3))
        ...
        ax1.set_ylabel(ylabel,fontsize = 14,rotation = 90,labelpad = 10)
