...
class Setup:
    ...
    def fit(self,**kwargs):
        ...
        if optimizer == 'gradient_descent':
            weight_hist, train_cost_hist, train_count_hist, valid_cost_hist, valid_count_hist = optimizers.gradient_descent(self.cost,self.counter,self.x_train,self.y_train,self.x_valid,self.y_valid,self.alpha_choice,self.max_its,self.w_init,self.num_pts,self.batch_size,verbose,version)
        
        if optimizer == 'RMSprop':
             weight_hist, train_cost_hist, train_count_hist, valid_cost_hist, valid_count_hist = optimizers.RMSprop(self.cost,self.counter,self.x_train,self.y_train,self.x_valid,self.y_valid,self.alpha_choice,self.max_its,self.w_init,self.num_pts,self.batch_size,verbose,version)
