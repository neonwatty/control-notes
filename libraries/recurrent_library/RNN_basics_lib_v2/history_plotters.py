...
class Setup:
    ...
    def plot_cost_histories(self,train_cost_histories,test_cost_histories,start):        
        ...
        for c in range(len(train_cost_histories)):
            ...
            ax.plot(np.arange(start,len(test_history),1),test_history[start:],linewidth = 3*(0.8)**(c),color = self.colors[1],label = 'test cost') 
    ...
    def plot_cost_count_histories(self,train_cost_histories,train_count_histories,test_cost_histories,test_count_histories,start):        
        ...
        for c in range(len(train_cost_histories)):
            ...
            ax2.plot(np.arange(start,len(test_count_history),1),test_count_history[start:],linewidth = 3*(0.8)**(c),color = self.colors[1],label = 'validation') 
